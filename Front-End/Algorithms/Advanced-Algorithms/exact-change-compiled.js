...
var currencyArray = [["ONE HUNDRED", 100.00], ["TWENTY", 20.00], ["TEN", 10.00], ["FIVE", 5.00], ["ONE", 1.00], ["QUARTER", 0.25], ["DIME", 0.10], ["NICKEL", 0.05], ["PENNY", 0.01]];
...
function checkCashRegister(price, cash, cid) {
    ...
    for (var _i = 0; _i < currencyArray.length; _i++) {
        if (largestCurr === currencyArray[_i][0]) {
            largestCurrencyPos = _i;
            break;
        }
    }
    ...
    change = [];
    for (var _i2 = largestCurrencyPos; _i2 < currencyArray.length; _i2++) {
        largestCurr = currencyArray[_i2][0];
        ...
        var amountToUse = amountOfCurrencyToUse(amountOfLargestCurrency, difference, currencyArray[_i2][1]);
...
//# sourceMappingURL=exact-change-compiled.js.map